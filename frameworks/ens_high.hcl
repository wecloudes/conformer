# Framework manifest — Spain ENS (CCN) for AWS, ENS Categoría ALTA.
#
# Mirrors the AWS Config conformance pack
# Operational-Best-Practices-for-CCN-ENS-High.yaml (awslabs/aws-config-rules),
...
# (run `scripts/plan-gate.sh tfplan ens_high`); GuardDuty is runtime-detective and
...
description = "Spain ENS (CCN) for AWS — ENS Categoría ALTA (RD 311/2022, CCN-ENS-High pack)"
