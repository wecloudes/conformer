# Framework manifest — Spain ENS (CCN) for AWS, ENS Categoría MEDIA.
#
# Mirrors the AWS Config conformance pack
# Operational-Best-Practices-for-CCN-ENS-Medium.yaml (awslabs/aws-config-rules),
...
# (run `scripts/plan-gate.sh tfplan ens_medium`); GuardDuty is runtime-detective and
...
description = "Spain ENS (CCN) for AWS — ENS Categoría MEDIA (RD 311/2022, CCN-ENS-Medium pack)"
